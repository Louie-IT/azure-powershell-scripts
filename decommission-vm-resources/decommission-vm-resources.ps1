# Make sure you are logged in to the correct Azure tenant/subscription before running this script.
# This script will prompt the user for an Azure virtual machine name, and delete the VM and any of the following objects related to the VM: 
# network interface, public IP address, network security group, data disk(s), OS disk.
